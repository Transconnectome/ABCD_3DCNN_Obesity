...
save_dir = "/Users/wangheehwan/Desktop/CNN_for_BMI/paper/data/statistics/result/CrossSectional/become_overweight_prob"
...
for (target in target_list){ 
    ...
    # perform analysis
    result = glm(as.formula(model), data=df, family=gaussian())
...
write.csv(result_summary, file = paste0(save_dir,'/',title,'_',year,'_become_overweight_prob.csv'), quote = FALSE, row.names=FALSE)
```
